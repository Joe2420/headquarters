...
contextBridge.exposeInMainWorld('headquarters', {
  ...
  listMissionContexts: () => ipcRenderer.invoke('headquarters:list-mission-contexts'),
  ...
  saveMissionContext: (input: unknown) => ipcRenderer.invoke('headquarters:save-mission-context', input),
